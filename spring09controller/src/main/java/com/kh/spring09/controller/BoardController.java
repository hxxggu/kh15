...
//	}
	...
	//- @ModelAttribute("pageVO")로 작성하면 model에 pageVO란 이름으로 추가됨
	@RequestMapping("/list")
...
//	}
	...
	public String delete(@RequestParam int boardNo) {
		...
		// 본문에 포함된 class="summernote-img"를 찾아서 지울 파일 번호를 추출
		// jQuery 였다면 ? $(".summernote-img").data("attachment-no");
		// Jsoup 라이브러리를 이용하여 문서를 HTML로 해석
...
//		boardDao.delete(boardNo);
	...
	public String edit(@ModelAttribute BoardDto boardDto) {
		...
		// - 기존 이미지가 1, 2, 3, 4번이고 신규 이미지가 1, 2, 5, 6번 이면 ?
		// - 제거할 이미지는 3, 4번
		// - 집합연산(차집합)으로 찾는다
